...
export default function HomePage() {
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-6 pb-10 pt-14 md:pt-24">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              {/* Link to the existing /prompts library the community already uses */}
              <Link
                href="/prompts"
      ...
      {/* Recent Prompts — links into the preserved /prompts route */}
      <section>
      ...
      {/* Footer — links to preserved community routes alongside new studios */}
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 text-sm text-foreground/30">
            ...
            <div className="flex flex-wrap gap-6">
              {/* Preserved community routes */}
              <Link href="/prompts" className="hover:text-foreground/60">
                Prompts
              </Link>
              <Link href="/prompt-generator" className="hover:text-foreground/60">
                Prompt Generator
              </Link>
              <Link href="/json-prompt" className="hover:text-foreground/60">
                JSON Prompt
              </Link>
              <Link href="/multi-shot" className="hover:text-foreground/60">
                Multi-Shot
              </Link>
              <Link href="/contribute" className="hover:text-foreground/60">
                Contribute
              </Link>
